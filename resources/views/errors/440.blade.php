...
<html>
  <head>
    ...
    <link rel="shortcut icon" href="{{asset('assets/img/ims.ico')}}">
    <link rel="apple-touch-icon" href="pages/ico/60.png">
    <link rel="apple-touch-icon" sizes="76x76" href="pages/ico/76.png">
    <link rel="apple-touch-icon" sizes="120x120" href="pages/ico/120.png">
    <link rel="apple-touch-icon" sizes="152x152" href="pages/ico/152.png">
    <link rel="icon" type="image/x-icon" href="pages/ico/ims.ico" />
  ...
  <body class="fixed-header error-page">
    <div class="d-flex justify-content-center full-height full-width align-items-center">
      <div class="error-container text-center">
        ...
        <h2 class="semi-bold" font-montserrat>Session time out</h2>
        <h2 class="semi-bold" font-montserrat><a href="/" title="home">LOGIN</a></h2>
      </div>
    </div>
    <!-- END OVERLAY -->
    <!-- BEGIN VENDOR JS -->
